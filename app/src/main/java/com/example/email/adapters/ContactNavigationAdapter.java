...
public class ContactNavigationAdapter extends BaseAdapter {

    private Context mContext;
    private ArrayList<ContactNavItem> mNavItems;

    public ContactNavigationAdapter(Context context, ArrayList<ContactNavItem> navItems) {
        mContext = context;
        mNavItems = navItems;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view = inflater.inflate(R.layout.drawer_contact_list_item, null);
        }
        else {
            view = convertView;
        }
